...
* 2. WorkSheet Activate
  ...
  DELI = CL_ABAP_CHAR_UTILITIES=>HORIZONTAL_TAB.  " & 구분기호를 변수로 선언
...
<FS_CONTENT>-LGOBE
    ...
    " 줄글로 변형된 레코드를 가지고 있는 ITAB의 데이터를 채우기

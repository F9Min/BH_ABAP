class ZCL_ZGW_0010_088_MPC definition
  public
...
TT_PO type standard table of TS_PO .
  ...
  constants GC_PO type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'PO' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGW_0010_088_MPC==========CP' ##NO_TEXT.
...
CLASS ZCL_ZGW_0010_088_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW_0010_088_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZEDUDV0010DDL088'
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250922050449'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'PO'.                            "#EC NOTEXT

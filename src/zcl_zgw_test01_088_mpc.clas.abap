class ZCL_ZGW_TEST01_088_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGW_TEST01_088_MPC========CP' ##NO_TEXT.
...
CLASS ZCL_ZGW_TEST01_088_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW_TEST01_088_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'Asso_BusinessPartner_Product' "#EC NOTEXT
                            iv_left_type        = 'BusinessPartner' "#EC NOTEXT
                            iv_right_type       = 'Product' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - Asso_BusinessPartner_Product
...
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'Asso_BusinessPartner_ProductSet'                         "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'BusinessPartner' "#EC NOTEXT
                                                              iv_abap_fieldname = 'BUSINESSPARTNER' "#EC NOTEXT
                                                              iv_association_name = 'Asso_BusinessPartner_Product' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW_TEST01_088_MPC=>TS_BUSINESSPARTNER' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20251129082016'.                  "#EC NOTEXT
